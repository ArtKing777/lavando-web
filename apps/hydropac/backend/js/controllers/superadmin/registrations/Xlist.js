app.controller('PowerUsersListCtrl', function($scope, $compile, $state, dataFactory, DTOptionsBuilder, DTColumnBuilder, DTInstances) {
    ...
    $scope.dtColumns = [
        ...
        DTColumnBuilder.newColumn('account.acccode').withTitle('Account Code').renderWith(function(data, type, full) {

            return full.account.acccode + ' ' + full.account.company_names;
