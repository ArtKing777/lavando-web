...
angular.module('app')
    ...
    function($scope, $rootScope, $translate, $localStorage, $window, AuthService, $state, $cookieStore, toaster) {
            ...
            $scope.getHeader = function (){
                ...
                return appConfig.appUrl + appConfig.module.name + '/' + MODULES + utype + '/' + TPL + 'blocks/header.html';
            }
            ...
            $scope.getAside = function(){
                var utype = AuthService.getPayload().utype;
                return appConfig.appUrl + appConfig.module.name + '/' + MODULES +  utype + '/' + TPL + 'blocks/aside.html';
            }

            $scope.getNav = function(){
                var utype = AuthService.getPayload().utype;
                return appConfig.appUrl + appConfig.module.name + '/' + MODULES +  utype + '/' + TPL + 'blocks/nav.html';
            }
