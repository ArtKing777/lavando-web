...
class PCAPredictDetailer
{
    ...
    {
        $url = "http://services.postcodeanywhere.co.uk/Capture/Interactive/Retrieve/v1.00/xmla.ws?";
...
//Example usage
//-------------
//$pa = new Capture_Interactive_Retrieve_v1_00 ("AA11-AA11-AA11-AA11","GBR|52509479","","","","","","","","","","","","","","","","","","","","");
//$pa->MakeRequest();
//if ($pa->HasData())
    //{
    //   $data = $pa->HasData();
