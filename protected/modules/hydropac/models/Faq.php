 ...
 */
class Faq extends ModuleActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, question, answer, priority, status_id, create_time, update_time, created_by_user_id, updated_by_user_id', 'safe', 'on'=>'search'),
		);
	}
