...
/**
 * This is the model class for table "tenancy_type".
 *
 * The followings are the available columns in table 'tenancy_type':
 * @property integer $id
 ...
 */
class TenancyType extends ModuleActiveRecord
{
	/**
	 ...
	 * @return TenancyType the static model class
	 */
