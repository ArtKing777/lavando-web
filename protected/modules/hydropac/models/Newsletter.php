 ...
 */
class Newsletter extends ModuleActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('status_id, created_by_user_id, updated_by_user_id', 'numerical', 'integerOnly'=>true),
			array('first_name, last_name, email', 'length', 'max'=>255),
			array('subscribe_date, create_time, update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, subscribe_date, first_name, last_name, email, status_id, create_time, update_time, created_by_user_id, updated_by_user_id', 'safe', 'on'=>'search'),
		);
	}
