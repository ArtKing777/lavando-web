 ...
 */
class Advisor extends ModuleActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('first_name, last_name, company_name, designation, address1, address2, address3, city, state, postcode, email, work_phone, home_phone, mobile_number, fax, url, skype_handel, dropbox_email, google_plus_handel, facebook_handel, twitter_handel, linkedin_handel, image1', 'length', 'max'=>255),
			array('remark, create_time, update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, first_name, last_name, company_name, designation, address1, address2, address3, city, state, country_id, postcode, email, work_phone, home_phone, mobile_number, fax, url, skype_handel, dropbox_email, google_plus_handel, facebook_handel, twitter_handel, linkedin_handel, image1, status_id, remark, priority, create_time, update_time, created_by_user_id, updated_by_user_id', 'safe', 'on'=>'search'),
		);
	}
