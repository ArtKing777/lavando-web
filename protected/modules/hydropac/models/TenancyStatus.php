...
/**
 * This is the model class for table "tenancy_status".
 *
 * The followings are the available columns in table 'tenancy_status':
 * @property integer $id
 ...
 */
class TenancyStatus extends ModuleActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'tenancies' => array(self::HAS_MANY, 'Tenancy', 'tenancy_status_id'),
	 ...
	 * @return TenancyStatus the static model class
	 */
