...
<section class="b-upcoming-event">
	...
	<div class="nacff_search_wrap gradient">
            <div class="container">
                ...
                <form action="<?php echo Yii::app()->createUrl("upcoming-classes") ?>" method="POST" class="default-form">
                    ...
                    <div class="b-search-map__fields">
                        ...
                        <div class="form-group">
                            <label class="field-label">&nbsp;</label>
                            <a class="thm-btn-tr" href="<?php echo Yii::app()->createUrl("site/viewliveclasses") ?>">View All Classes</a> 
                        </div>
                    </div>
                </form>                
            </div>
